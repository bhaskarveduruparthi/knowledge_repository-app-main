...
export class ViewHistory implements OnInit {
    ...
    ngOnInit() {
        const storedPage = localStorage.getItem('VHistoryCurrentPage');
        if (storedPage) {
            this.VHistoryCurrentPage = parseInt(storedPage);
            this.loadDemoData(this.VHistoryCurrentPage);
            this.first = (this.VHistoryCurrentPage - 1) * 10;
        } else {
            this.VHistoryCurrentPage = 1;
            localStorage.setItem('VHistoryCurrentPage', this.VHistoryCurrentPage.toString());
            this.loadDemoData(this.VHistoryCurrentPage);
            this.first = (this.VHistoryCurrentPage - 1) * 10;
        }
        this.form_records();
    ...
    loadDemoData(page: number) {
        this.managereposervice.getallviewlogs(page).subscribe((data: any) => {
    ...
    onPageChange(event: any) {
        this.VHistoryCurrentPage = event.page + 1;
        this.loadDemoData(this.VHistoryCurrentPage);
        localStorage.setItem('VHistoryCurrentPage', this.VHistoryCurrentPage.toString());
    }
    ...
    form_records() {
        this.managereposervice.get_viewlog_records().subscribe((data: any) => {
