...
export class ManagePendingReport implements OnInit {
    private static readonly VIEW_MODE_KEY = 'pendingReportViewMode';
    ...
    setViewMode(mode: 'table' | 'card'): void {
        this.viewMode = mode;
        localStorage.setItem(ManagePendingReport.VIEW_MODE_KEY, mode);
    }
    ...
    ngOnInit() {
        ...
        const savedMode = localStorage.getItem(ManagePendingReport.VIEW_MODE_KEY);
