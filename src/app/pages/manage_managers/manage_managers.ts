    ...
    template: `
        ...
        <div class="card">
            <p-toolbar styleClass="mb-6">
                <ng-template #start>
                  <p-button label="Add Manager" icon="pi pi-plus" severity="primary" (onClick)="openNew()"  />
                </ng-template>
                <ng-template #end>
            ...
            <div class="flex items-center justify-between mb-3">
                <h5 class="m-0">Manage Managers</h5>
                <p-iconfield>
            ...
            <p-paginator 
                ...
                currentPageReportTemplate="Showing {first} to {last} of {totalRecords} Managers"
...
export class ManageManagers implements OnInit {
    ...
    loadDemoData() {
        this.manageadminservice.getManagers().subscribe((data: any) => {
            this.users.set(data);
