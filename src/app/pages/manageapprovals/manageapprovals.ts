                ...
                <div class="card-grid" *ngIf="!loading && filteredRepositories().length > 0">
                    <div class="repo-card" *ngFor="let repo of filteredRepositories()">
                        ...
                        <div class="card-meta">
                            ...
                            <div class="card-meta-item">
                                <span>Approver</span>{{ repo.Approver || '—' }}
                            </div>
                            <div class="card-meta-item">
                                <span>Approval Date</span>{{ repo.Approval_date || '—' }}
                            </div>
                        </div>
...
export class ManageApprovalsReport implements OnInit {
    private static readonly VIEW_MODE_KEY = 'approvalReportViewMode';
    ...
    setViewMode(mode: 'table' | 'card'): void {
        this.viewMode = mode;
        localStorage.setItem(ManageApprovalsReport.VIEW_MODE_KEY, mode);
    }
    ...
    ngOnInit() {
        ...
        const savedMode = localStorage.getItem(ManageApprovalsReport.VIEW_MODE_KEY);
